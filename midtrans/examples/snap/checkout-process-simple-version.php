...
Config::$serverKey = 'SB-Mid-server-f1rmoYEUQaFlZ6oj5S1CuROm';
Config::$clientKey = 'SB-Mid-client-ofKh-kdTz7ljyWUu';
...
<div class="card">
  <div class="card-body">
      <p>Registrasi Berhasil, Selesaikan Pembayaran Sekarang</p>
        ...
        <a href="http://localhost/airline_reservation_pertama/pesanan.php" class="btn btn-primary">KEMBALI</a>
          </div>
          </div>
          </div>
